...
function Layout() {
  ...
  const [recentTrades, setRecentTrades] = useState([
    {
      id: 1,
      title: "Rare Isotope Fuel Cell - 3 units",
      type: "physical",
      status: "AVAILABLE",
      createdAt: Date.now(),
    },
    {
      id: 2,
      title: "Military-Grade Encryption Module v7.3",
      type: "physical",
      status: "AVAILABLE",
      createdAt: Date.now(),
    },
  ...
  const criticalAlerts = recentJobs.filter(
  ...
  const jobTemplates = [
    {
      title: "Data Courier - Central Hub Transfer",
      sector: "Transport",
      level: "NORMAL",
    },
    {
      title: "Security Patrol - Sector 3 Perimeter",
      sector: "Security",
      level: "NORMAL",
    },
    {
    ...
    {
      title: "Circuit Board Assembly - Factory Line",
    ...
    {
      title: "Drone Maintenance Specialist",
      sector: "Engineering",
      level: "HIGH",
    },
    {
    ...
    {
      title: "Surveillance System Calibration",
      sector: "Security",
      level: "NORMAL",
    },
    {
      title: "Bio-waste Containment",
      sector: "Environmental",
      level: "CRITICAL",
    },
  ];
  ...
  const tradeTemplates = [
    {
      title: "Neural Implant Processor - High Grade",
      type: "physical",
      status: "AVAILABLE",
    },
    {
      title: "Quantum Data Crystal - 500TB Storage",
      type: "digital",
      status: "AVAILABLE",
    },
    {
      title: "Bio-Engineered Nutrient Paste - 50kg",
      type: "physical",
      status: "AVAILABLE",
    },
    {
      title: "Holographic Display Matrix - 8K Resolution",
      type: "physical",
      status: "AVAILABLE",
    },
    {
      title: "AI Personality Core - Learning Algorithm",
      type: "digital",
      status: "AVAILABLE",
    },
    {
      title: "Plasma Conduit - Industrial Grade",
      type: "physical",
      status: "AVAILABLE",
    },
    {
      title: "Cybernetic Enhancement Kit - Basic",
      type: "physical",
      status: "AVAILABLE",
    },
    {
      title: "Encrypted Communication Protocol - v9.2",
      type: "digital",
      status: "AVAILABLE",
    },
    {
      title: "Nanobot Swarm - Medical Grade",
      type: "physical",
      status: "AVAILABLE",
    },
    {
      title: "Virtual Reality Construct - Custom Build",
      type: "digital",
      status: "AVAILABLE",
    },
  ];
  ...
  const [activityFeed, setActivityFeed] = useState([
    {
      user: "admin_steele",
      action: "Listed trade: Rare Isotope Fuel Cell - 3 units",
      time: "12:13 AM",
    },
    {
      user: "admin_steele",
      action: "Posted job: Data Runner - Steel District Archives",
      time: "12:13 AM",
    },
  ]);
  ...
  const addRandomContent = () => {
    ...
    if (shouldAddJob) {
      ...
      setRecentJobs((prevJobs) =>
        [newJob, ...prevJobs].slice(0, maxRecentItems),
      );
      ...
      const randomTrade =
        tradeTemplates[Math.floor(Math.random() * tradeTemplates.length)];
      const newTrade = {
      ...
      setRecentTrades((prevTrades) =>
        [newTrade, ...prevTrades].slice(0, maxRecentItems),
      );
      setActivityFeed((prevFeed) =>
        [
          {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      setRecentJobs((prev) =>
        prev.filter((item) => now - item.createdAt < recentItemLifetime),
      );
